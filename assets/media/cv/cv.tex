...
presents legislative data on the Quorum SaaS platform. Responsibilities include:

	\begin{itemize}[noitemsep]
		\item Re-write of core portion of Quorum \textbf{Search} using React, Django, Tastypie, Redux, Stylus, ES6. 
		\item Re-designed site-wide style to include media queries and removed thousands of stale style rules.
		\item Bi-monthly \textbf{deployment}, \textbf{on-call}, dev-ops, \textbf{full-stack} projects
		\item ``\textbf{Learning Lab}'' presentations, organization of weekly dev-team \textbf{social events}, on-site client demos
...
\textit{Software Engineering Research Intern (DoD Secret Clearance)}
\hfill
\textit{Summer 2016}
